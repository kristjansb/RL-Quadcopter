...
class Hover(BaseTask):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(
            np.array([- cube_size / 2, - cube_size / 2,       0.0, -1.0, -1.0, -1.0, -1.0, -max_velocity, -max_velocity, -max_velocity]),
            np.array([  cube_size / 2,   cube_size / 2, cube_size,  1.0,  1.0,  1.0,  1.0, max_velocity, max_velocity, max_velocity]))
        ...
        self.start_position = np.array([0.0, 0.0, 5.0])  # start on 5 units below the target position
    ...
    def update(self, timestamp, pose, angular_velocity, linear_acceleration):
        ...
        if error_position > self.max_error_position:
            ...
            reward += 50.0  # extra reward, agent has made it to the end
            done = True
